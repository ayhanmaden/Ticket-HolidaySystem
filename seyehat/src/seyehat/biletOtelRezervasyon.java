 ...
 * @author meryemezber
 */
public class biletOtelRezervasyon extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame1
     */
    public biletOtelRezervasyon() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(biletOtelRezervasyon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new biletOtelRezervasyon().setVisible(true);
            }
        });
    }
